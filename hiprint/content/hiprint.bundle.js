...
var hiprint = function (t) {
    ...
    var i = function () {
        ...
        uu = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item">\n        <div class="hiprint-option-item-label">\n        显示标题行\n        </div>\n        <div class="hiprint-option-item-field">\n            <select class="auto-submit">\n            <option value="" >默认</option>\n            <option value="border" >显示</option>\n            <option value="noBorder" >不显示</option>\n            </select>\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("select").val();
                if (t) return t.toString();
            }, t.prototype.setValue = function (t) {
        ...
        RM = function () {
            function t() {
                this.name = "rightMargin";
            }

            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        右边距\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="右边距" class="auto-submit">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                if (t) return parseFloat(t.toString());
            }, t.prototype.setValue = function (t) {
        ...
        TM = function () {
            ...
            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        上边距\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="上边距" class="auto-submit">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                if (t) return parseFloat(t.toString());
            }, t.prototype.setValue = function (t) {
        ...
        LM = function () {
            function t() {
                this.name = "leftMargin";
            }

            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        左边距\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="左边距" class="auto-submit">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                if (t) return parseFloat(t.toString());
            }, t.prototype.setValue = function (t) {
        ...
        BM = function () {
            function t() {
                this.name = "bottomMargin";
            }

            return t.prototype.createTarget = function () {
                return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        下边距\n        </div>\n        <div class="hiprint-option-item-field">\n        <input type="text" placeholder="下边距" class="auto-submit">\n        </div>\n    </div>'), this.target;
            }, t.prototype.getValue = function () {
                var t = this.target.find("input").val();
                console.log(t);
                if (t) return parseFloat(t.toString());
    ...
    var _r,
        ...
        T = function () {
            ...
            return t.prototype.subscribePaperBaseInfoChanged = function (t) {
                ...
                this.bottomMargin = t, this.leftMargin = t, this.rightMargin = t, this.topMargin = t, this.firstPaperFooter = t, this.evenPaperFooter = e, this.oddPaperFooter = n, this.lastPaperFooter = i;
                ...
                this.createHeaderLine(),
                    ...
                    this.paperNumberTarget = this.createPaperNumber(this.formatPaperNumber(1, 1)), this.createRuler(), this.resetPaperNumber(this.paperNumberTarget), $(this.paperNumberTarget).bind("dblclick.hiprint", function () {
        ...
        rt = function () {
            return function (t) {
                ...
                this.paperHeader = t.paperHeader || 0, this.paperFooter = t.paperFooter || o.a.mm.toPt(this.height), this.printElements = t.printElements || [], this.paperNumberLeft = t.paperNumberLeft, this.paperNumberTop = t.paperNumberTop, this.paperNumberDisabled = t.paperNumberDisabled, this.paperNumberFormat = t.paperNumberFormat, this.panelPaperRule = t.panelPaperRule, this.bottomMargin = t.bottomMargin, this.rotate = t.rotate || void 0, this.bottomMargin = t.bottomMargin, this.firstPaperFooter = t.firstPaperFooter, this.evenPaperFooter = t.evenPaperFooter, this.oddPaperFooter = t.oddPaperFooter, this.lastPaperFooter = t.lastPaperFooter, this.topOffset = t.topOffset, this.fontFamily = t.fontFamily, this.leftOffset = t.leftOffset, this.orient = t.orient;
            };
        }(),
        at = function () {
            function t(t, e, n, i) {
        ...
        pt = function () {
            function t(t, e) {
                this.templateId = e, this.index = t.index, this.width = t.width, this.height = t.height, this.paperType = t.paperType, this.paperHeader = t.paperHeader, this.paperFooter = t.paperFooter, this.initPrintElements(t.printElements), this.paperNumberLeft = t.paperNumberLeft, this.paperNumberTop = t.paperNumberTop, this.paperNumberDisabled = t.paperNumberDisabled, this.paperNumberFormat = t.paperNumberFormat, this.panelPaperRule = t.panelPaperRule, this.rightMargin = t.rightMargin, this.leftMargin = t.leftMargin, this.topMargin = t.topMargin, this.bottomMargin = t.bottomMargin, this.firstPaperFooter = t.firstPaperFooter, this.evenPaperFooter = t.evenPaperFooter, this.oddPaperFooter = t.oddPaperFooter, this.lastPaperFooter = t.lastPaperFooter, this.topOffset = t.topOffset, this.leftOffset = t.leftOffset, this.fontFamily = t.fontFamily, this.orient = t.orient, this.target = this.createTarget(), this.rotate = t.rotate;
            }
            ...
            return t.prototype.design = function (t) {
                ...
                this.orderPrintElements(), this.designPaper = this.createNewPage(0), this.target.html(""), this.target.append(this.designPaper.getTarget()), this.droppablePaper(this.designPaper), this.designPaper.design(t), this.designPaper.subscribePaperBaseInfoChanged(function (t) {
                    ...
                    o.a.event.trigger("BuildCustomOptionSettingEventKey_" + e.templateId, {
                        ...
                        callback: function callback(t) {
                            e.panelPaperRule = t.panelPaperRule, e.topMargin = t.topMargin, e.rightMargin = t.rightMargin, e.leftMargin = t.leftMargin, e.bottomMargin = t.bottomMargin, e.firstPaperFooter = t.firstPaperFooter, e.evenPaperFooter = t.evenPaperFooter, e.oddPaperFooter = t.oddPaperFooter, e.lastPaperFooter = t.lastPaperFooter, e.leftOffset = t.leftOffset, e.topOffset = t.topOffset, e.fontFamily = t.fontFamily, e.orient = t.orient, e.paperNumberFormat = t.paperNumberFormat, e.designPaper.setOffset(e.leftOffset, e.topOffset), e.css(e.target);
                        }
                    });
                ...
                return this.printElements.forEach(function (n) {
                    ...
                    leftMargin: this.leftMargin ? this.leftMargin : void 0,
                    rightMargin: this.rightMargin ? this.rightMargin : void 0,
                    topMargin: this.topMargin ? this.topMargin : void 0,
                    bottomMargin: this.bottomMargin ? this.bottomMargin : void 0,
                ...
                return n.setFooter(this.leftMargin, this.topMargin, this.rightMargin, this.bottomMargin, this.firstPaperFooter, this.evenPaperFooter, this.oddPaperFooter, this.lastPaperFooter), n.setOffset(this.leftOffset, this.topOffset), n;
        ...
        ut = function () {
            ...
            return t.prototype.init = function () { }, t.prototype.buildSetting = function (t) {
                ...
                r.prepend(a), r.prepend(p), a.bind("click.submitOption", function () {
                    i.submitOption();
